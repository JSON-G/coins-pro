...
<ol>
  <li>Login to the Coins Pro website at [https://exchange.coins.asia/](https://exchange.coins.asia/)</li>
  <li>Go to [API Key Management](https://exchange.coins.asia/keys). This can also be accessed via the website hamburger menu.</li>
